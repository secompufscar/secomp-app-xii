...
export default function RegistrationDetails() {
    ...
    return (
        <View className='bg-white flex-1 px-8'>
            ...
            <View className="h-[80%] absolute bottom-0 left-0 right-0 mt-16">
                <View className='h-full px-10 py-8 flex flex-col justify-start bg-white rounded-t-[36px]' style={(isIos) ? [styles.shadowProp] : [styles.elevation]}>
